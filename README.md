...
simply clone this archive (or download this script), then make this script executable with sudo chmod +x; afterwards run ```bash ./vfio-gen-aio.sh``` in your terminal of choice.
